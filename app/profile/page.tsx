    ...
    <AppLayout activeHref="/profile">
      ...
      <main className="p-8 space-y-6 max-w-2xl">
        ...
        <div className="rounded-2xl px-6 py-5" style={{ background: "rgba(239,68,68,0.06)", border: "1px solid rgba(239,68,68,0.18)" }}>
          ...
          <p className="text-xs mb-4" style={{ color: "#7f1d1d" }}>Kontakt os på kontakt@lysbro.com, så sletter vi din konto og alle tilhørende data inden for 30 dage.</p>
          <a href="mailto:kontakt@lysbro.com?subject=Sletning af konto" className="inline-block rounded-xl px-4 py-2 text-sm font-medium transition-all" style={{ background: "rgba(239,68,68,0.1)", border: "1px solid rgba(239,68,68,0.25)", color: "#f87171" }}>
            Slet min konto
          </a>
        </div>
