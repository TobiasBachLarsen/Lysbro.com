...
export function LysbroLogoFull({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 100 100" fill="white" xmlns="http://www.w3.org/2000/svg">
      ...
      {/* Curved "LYSBRO" text on top arc */}
      <defs>
        <path id="topArc" d="M 6 50 A 44 44 0 0 1 94 50" />
      </defs>
      <text fontSize="9.5" fontFamily="system-ui, -apple-system, sans-serif" fontWeight="700" letterSpacing="4" fill="white">
        <textPath href="#topArc" startOffset="50%" textAnchor="middle">LYSBRO</textPath>
      </text>
    </svg>
  );
}
