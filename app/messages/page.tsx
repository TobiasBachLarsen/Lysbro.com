                      ...
                      {isOrgInvite ? (
                        ...
                        <div className="max-w-xs w-full rounded-2xl overflow-hidden" style={{
                          ...
                          <div className="px-4 pt-4 pb-3">
                            ...
                            <p className="text-sm font-bold text-white mb-1">{msg.meeting_data!.title}</p>
                            <p className="text-xs" style={{ color: "#64748b" }}>
                              {new Date(msg.meeting_data!.date).toLocaleDateString("da-DK", { weekday: "long", day: "numeric", month: "long" })} · {msg.meeting_data!.time}
                            </p>
                            {!isMine && msg.invite_status === "pending" && (
                              <div className="flex gap-2 mt-3">
